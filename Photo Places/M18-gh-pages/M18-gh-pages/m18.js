    ...
    enter.addEventListener('click', function() {
        ...
        reader.onload = function(e) {
            ...
            image.onload = function() {
				...
				var font_size_cn = canvas.width / 49,
					font_size_eng = canvas.width * 7 / 495;
					
                // chinese
                context.beginPath()
                context.font = `normal ${font_size_cn}px Lucida Grande, Helvetica Neue, Helvetica, Arial`;

                var cnArea = context.measureText(cn);
                context.fillText(cn, canvas.width / 2 - cnArea.width / 2, canvas.height - font_size_eng * 2.0)

                // english
                context.beginPath()
                context.font = `normal ${font_size_eng}px Lucida Grande, Helvetica Neue, Helvetica, Arial`;

                var enArea = context.measureText(en);
                context.fillText(en, canvas.width / 2 - enArea.width / 2, canvas.height - font_size_eng * 0.7)
